...
public class HiveVarcharPrimitiveConverter implements IHivePrimitiveConverter {

  private final HiveVarcharObjectInspector inspector;

  public HiveVarcharPrimitiveConverter( final HiveVarcharObjectInspector inspector ) {
