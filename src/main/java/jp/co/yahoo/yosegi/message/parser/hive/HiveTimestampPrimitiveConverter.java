...
public class HiveTimestampPrimitiveConverter implements IHivePrimitiveConverter {

  private final TimestampObjectInspector inspector;

  public HiveTimestampPrimitiveConverter( final TimestampObjectInspector inspector ) {
