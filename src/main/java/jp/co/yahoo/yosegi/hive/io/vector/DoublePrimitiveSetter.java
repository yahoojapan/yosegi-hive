...
public class DoublePrimitiveSetter implements IDecimalPrimitiveSetter {

  private static final DoublePrimitiveSetter SETTER = new DoublePrimitiveSetter();
  ...
  public static DoublePrimitiveSetter getInstance() {
    return SETTER;
  }
