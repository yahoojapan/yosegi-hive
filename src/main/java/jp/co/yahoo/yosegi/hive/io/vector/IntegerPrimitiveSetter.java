...
public class IntegerPrimitiveSetter implements INumberPrimitiveSetter {

  private static final IntegerPrimitiveSetter SETTER = new IntegerPrimitiveSetter();
  ...
  public static IntegerPrimitiveSetter getInstance() {
    return SETTER;
  }
