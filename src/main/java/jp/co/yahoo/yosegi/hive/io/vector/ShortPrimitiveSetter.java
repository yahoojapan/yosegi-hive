...
public class ShortPrimitiveSetter implements INumberPrimitiveSetter {

  private static final ShortPrimitiveSetter SETTER = new ShortPrimitiveSetter();
  ...
  public static ShortPrimitiveSetter getInstance() {
    return SETTER;
  }
