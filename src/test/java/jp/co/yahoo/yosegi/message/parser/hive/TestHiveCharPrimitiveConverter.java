...
public class TestHiveCharPrimitiveConverter {

  @Test
  public void T_1() throws IOException{
    HiveCharPrimitiveConverter converter = new HiveCharPrimitiveConverter(
        PrimitiveObjectInspectorFactory.writableHiveCharObjectInspector );

    HiveCharWritable charObj = new HiveCharWritable();
